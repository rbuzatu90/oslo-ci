...
run_wsmancmd_with_retry $hyperv01 $WIN_USER $WIN_PASS 'powershell -executionpolicy remotesigned C:\OpenStack\oslo-ci\HyperV\scripts\export-eventlog.ps1'
...
run_wsmancmd_with_retry $hyperv02 $WIN_USER $WIN_PASS 'powershell -executionpolicy remotesigned C:\OpenStack\oslo-ci\HyperV\scripts\export-eventlog.ps1'
